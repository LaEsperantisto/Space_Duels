...
extern const int title_top_left_x_offset;
extern const int title_top_left_y_offset;

extern const int start_button_width;
extern const int start_button_height;

extern const int start_button_top_left_x_offset;
extern const int start_button_top_left_y_offset;
